...
public abstract class GenericConverter<A, B> {
    ...
    public A toA(B value) { return mapperFactory.getMapperFacade().map(value, getFirstClass()); }

    public B toB(A value) { return mapperFactory.getMapperFacade().map(value, getSecondClass()); }
